...
dist    = LUMDIST(z,H0=H0,lambda0=omega_l,omega_m=omega_m,/SILENT)  ;luminosity of object distance
l2f     = 10^(ALOG10(3.826e1) + ALOG10(zp_c_fl) - $
              ALOG10(4.*!PI*(1.+z)*(dist*3.0856776e8)^2)) ;transfors into log, adds then takes the exponent. dist outo to be a vector so is l2f
RETURN,l2f
