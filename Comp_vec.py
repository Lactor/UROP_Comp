...
if len(sys.argv) == 2 and (sys.argv[1] == "--help" or sys.argv[1] == "-h"):
    ...
    \n\
    python3 data_folder result_folder inp_file1 inp_file2 ...\n\n")
    sys.exit()
...
for k in range(len(input_files_data)):
    ...
    if( results[k][0][0]< 1):
        ...
        print(result_folder +str(get_number(input_file_names[k]))+ ".out")
    output = open(result_folder +str(get_number(input_file_names[k]))+ ".out", "w") 
        #Open file
